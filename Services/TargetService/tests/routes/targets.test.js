...
describe('Get Targets', () => {
    ...
    it('should get all targets', async () => {
        const target = await new Target({location: {lat: 42.546778, lon: 12.124589}, userId: '123456789'}).save();
    ...
    it('should get all targets by userId', async () => {
        const target = await new Target({location: {lat: 42.546778, lon: 12.124589}, userId: 'userId1'}).save();
    ...
    it('should get a target by id', async () => {
        const target = await new Target({location: {lat: 42.546778, lon: 12.124589}, userId: 'userId'}).save();
